...
from app.video_engine.services import twelvelabs
...
@unittest.skipUnless(
    ...
    "live test: set AI_CUSTOMER_VIDEO_INTEGRATION_TESTS=1 and TWELVELABS_API_KEY to run "
    "against the real TwelveLabs API",
)
class TestTwelveLabsLive(unittest.TestCase):
    """Live contract check — only runs with AI_CUSTOMER_VIDEO_INTEGRATION_TESTS=1 + a key."""
