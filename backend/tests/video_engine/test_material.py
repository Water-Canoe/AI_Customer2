...
from app.video_engine.services import material
...
class TestMaterialTlsVerification(unittest.TestCase):
    ...
    def test_search_pexels_uses_tls_verification_by_default(self):
        ...
        with patch("app.video_engine.services.material.requests.get", return_value=fake_response) as get:
    ...
    def test_save_video_uses_tls_verification_by_default(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch(
                "app.video_engine.services.material.requests.get", return_value=fake_response
            ) as get, patch("app.video_engine.services.material.VideoFileClip", FakeVideoFileClip):
...
class TestCoverrProvider(unittest.TestCase):
    ...
    def test_download_videos_passes_mp4_download_url_to_save_video(self):
        ...
        with patch(
            "app.video_engine.services.material.search_videos_coverr",
            return_value=[fake_item],
        ) as search, patch(
            "app.video_engine.services.material.save_video",
