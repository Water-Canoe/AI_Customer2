...
from app.video_engine.models.schema import VideoScriptRequest, VideoSocialMetadataRequest
...
@unittest.skipUnless(
    ...
    "AI_CUSTOMER_VIDEO_INTEGRATION_TESTS and ANTHROPIC_FOUNDRY_API_KEY not set",
)
