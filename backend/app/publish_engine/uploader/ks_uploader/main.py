...
from app.publish_engine.utils.login_qrcode import remove_qrcode_file
from app.publish_engine.utils.login_qrcode import save_data_url_image
from app.publish_engine.utils.log import kuaishou_logger
...
class KSVideo(KSBaseUploader):
    ...
    async def upload(self) -> None:
        ...
        context = await launch_publish_context(headless=self.headless, account_file=self.account_file)
