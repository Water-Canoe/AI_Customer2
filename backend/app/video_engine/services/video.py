...
from app.video_engine.models.schema import (
    MaterialInfo,
    VideoAspect,
    VideoConcatMode,
    VideoParams,
...
from app.video_engine.services.utils import video_effects
...
def generate_video(
    ...
    # Keep audio duration aligned with the final frame sequence.
