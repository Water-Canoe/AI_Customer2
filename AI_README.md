...
7. 在“私信工作台”按平台折叠的关键词队列筛选目标客户，批量推进私信、回访、回复和成交状态；抖音客户可点击“自动私信”直接调用 CloakBrowser 打开主页、按设置页选择发送 AI 话术或固定话术并标记为已私信，也可以按关键词设置私信数量和时间间隔启动“AI一键私信”批次；若设置页开启“自动私信只填内容不发送”，则只填话术并等待人工点击发送。
