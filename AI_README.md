...
2. 在“任务管理”页选择四种模式之一：竞品账号采集、竞品账号爬取、找需求内容、自家账号互动；页面会按当前平台和模式显示输入要求、预计产出、字段能力和风险提示。
